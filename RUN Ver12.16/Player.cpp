...
void Player::Init(void)
{
	...
	data.reserve(1);
	data.emplace_back( IMAGE_ID("ｷｬﾗ")[0], 8 );
	data.emplace_back( IMAGE_ID("ｷｬﾗ")[1], 16 );
	data.emplace_back( IMAGE_ID("ｷｬﾗ")[2], 24 );
	data.emplace_back( IMAGE_ID("ｷｬﾗ")[3], 32 );
	data.emplace_back( IMAGE_ID("ｷｬﾗ")[4], 40 );
